...
const NoticeBoard = () => {
  return (
    <section className={`${styles.noticeBoard} p-2 px-3 shadow-sm rounded-2 d-flex flex-column gap-2`}>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center gap-3" style={{ height: '100%', width: '100%' }}>
        <img
          className="mx-auto"
