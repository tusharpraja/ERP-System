...
import styles from './BirthdayBoard.module.css'; // Make sure this import is correct
...
const BirthdayBoard = ({ birthdays }) => {
  ...
  const visibleBirthdays = birthdayData.slice(0, 6); // Only show first 6 birthdays

  return (
    <div className={styles.birthdayBoard}>
      <div className={styles.header}>
        ...
        <div className={styles.countBadge}>{birthdayData.length}</div>
      </div>

      <div className={styles.birthdayList}>
        {visibleBirthdays.map((person) => (
          <div key={person.id} className={styles.birthdayCard}>
            <div className={styles.personInfo}>
              <div className={styles.avatar}>
                {person.imageUrl ? (
                  <img src={person.imageUrl} alt={person.name} />
                ) : (
                  <span>{person.initials || 
            ...
            <div className={styles.birthdayInfo}>
              <span className={styles.daysUntil}>In {person.daysUntil} days</span>
              <span className={styles.date}>{person.date}</span>
            </div>
