...
import './state.css'; // Assuming you have a CSS file for styling

const State = () => {
  // Sample data for the states
  const [states, setStates] = useState([
    { id: 1, country: 'India', state: 'Uttar Pradesh' },
    { id: 2, country: 'India', state: 'Bihar' },
    { id: 3, country: 'India', state: 'Gujrat' }
  ]);

  return (
    <div className="state-container">
      <div className="state-header">
        <h2>State Details ({states.length})</h2>
