    ...
    <div className="mainbar-grid">
      <div className="pb-4" style={{ overflow: 'auto' }}>
        <div className="container-fluid">
          ...
          {salaryData.status === 'not processed' ? (
            <div className="container-fluid d-flex align-items-center flex-column gap-3 justify-content-center my-2 bg-light text-dark" 
                 style={{ height: '80vh', width: '100%' }}>
              <div style={{ height: '18rem', width: 'auto' }}>
                <img src="/static/media/Salary.22972a96.png" alt="No Salary" style={{ height: '100%', width: '100%' }} />
              </div>
              Salary has not been processed yet. Contact HR for details.
            </div>
          ) : (
            <div className="salary-slip-container">
              {/* This would show the actual salary slip when available */}
              <div className="salary-slip-content">
                {/* Salary slip details would go here */}
              </div>
            </div>
          )}
        </div>
      ...
      <div className="HrPannelFooter bg-dark w-100 text-white" style={{ zIndex: 50, position: 'absolute', bottom: '0px' }}>
        <div className="d-flex justify-content-center align-items-center gap-5 p-2" 
          ...
          <span className="d-none d-md-flex">
            <span className="text-capitalize">{salaryData.date}, {salaryData.time}</span>
          </span>
